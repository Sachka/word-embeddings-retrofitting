...
// Program to convert vectors between text and binary format
...
int main(int argc, char **argv) {
    if (argc < 4) {
        printf("USAGE: convertvec method input output\n");
        printf("Method is either bin or txt\n");
        return 0;
    }

    if(strcmp(argv[1], "to_text") == 0)
